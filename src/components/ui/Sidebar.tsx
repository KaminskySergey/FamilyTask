import { ListTodo, CalendarCheck2, Settings, ChevronRight, LayoutDashboard, ChevronLeft, Users, ChartNoAxesCombined } from 'lucide-react'
...
export default function SideBar() {
    ...
    return (
        <aside className={cn("bg-white relative dark:bg-[#101828] dark:shadow-[6px_6px_12px_#0a0a0a,-6px_-6px_12px_#1f2937] hidden  shadow-md rounded-br-2xl  md:flex flex-col justify-between  text-black dark:text-white h-full transition-width duration-300 ease-in-out px-4 pb-6 pt-3", {
            "w-64": isSidebarOpen,
            "w-18": !isSidebarOpen
        })}>
            <div className='flex flex-col gap-5'>
                <div
                    ...
                    className={cn(
                        "absolute top-3 -right-5 z-50 h-7 w-7 bg-white dark:bg-gray-800 flex items-center justify-center rounded-lg hover:text-primary cursor-pointer transition-all duration-500",
                        {
